...
export function InsightsSection() {
  return (
    <section id="insights" className="py-32 bg-gradient-to-b from-white via-blue-50/20 to-white relative overflow-hidden">
        ...
        <AnimatedSection>
          <div className="max-w-3xl mx-auto text-center mb-20">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Актуальные материалы от наших экспертов о трендах
              инвестиционного рынка и правовом регулировании
            </p>
          </div>
        </AnimatedSection>
                  ...
                  <Card className="group overflow-hidden bg-white/90 backdrop-blur-sm border-2 hover:border-transparent hover:shadow-2xl h-full flex flex-col relative transition-all duration-500">
                    ...
                    <div className="relative h-64 overflow-hidden">
                      ...
                      <div className="absolute top-4 right-4">
                        <div className={`px-4 py-2 rounded-full bg-white/90 backdrop-blur-md shadow-lg`}>
                    ...
                    <div className="p-8 flex flex-col flex-grow relative z-10">
                      ...
                      <div className="flex flex-wrap gap-2 mb-6">
                        {insight.tags.map((tag) => (
                          <Badge key={tag} className="bg-blue-600 text-white border-0">
                            {tag}
                          </Badge>
                        ))}
                      </div>
