...
import { partners, clients } from '@/content/partners';
      ...
      <div className="container mx-auto px-4">
        ...
        <AnimatedSection delay={0.3}>
          <div className="mt-16 text-center">
            <div className="inline-flex items-center gap-8 bg-white rounded-2xl px-12 py-8 shadow-lg border border-slate-200">
